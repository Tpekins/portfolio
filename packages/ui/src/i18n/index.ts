...
const translations = {
  EN: {
    ...
    projects: {
      ...
      description: "LocalHands is a platform built to bridge the gap between local service providers and people who need them across Cameroon. From handymen to creatives, LocalHands makes it simple to find, book, and trust local talent.",
      responsibilities: "Key Responsibilities:",
      resp1: "Brainstorming: Conceptualizing the platform vision and core features",
      resp2: "UI/UX Design: Crafting an intuitive interface for service providers and clients",
      resp3: "Front-End Development: Building responsive, dynamic components",
      resp4: "Deployment: Shipping and maintaining the live product",
      tools: "Tools:",
      tool1: "React: Main frontend library for component-based architecture",
      tool2: "TypeScript: Ensuring type safety and better developer experience",
      tool3: "Tailwind CSS: Utility-first CSS framework for rapid UI development",
      tool4: "Vercel: Cloud platform for static sites and Serverless Functions",
  ...
  FR: {
    ...
    projects: {
      ...
      name: "LocalHands",
      subtitle: "Connecter les communautés avec des mains qualifiées",
      category: "Plateforme · Marché de services",
      description: "LocalHands est une plateforme conçue pour combler le fossé entre les prestataires de services locaux et les personnes qui en ont besoin à travers le Cameroun. Des bricoleurs aux créatifs, LocalHands simplifie la recherche, la réservation et la confiance envers les talents locaux.",
      responsibilities: "Responsabilités clés :",
      resp1: "Brainstorming : Conceptualiser la vision de la plateforme et les fonctionnalités principales",
      resp2: "UI/UX Design : Concevoir une interface intuitive pour les prestataires et les clients",
      resp3: "Développement Front-End : Construire des composants réactifs et dynamiques",
      resp4: "Déploiement : Livrer et maintenir le produit en production",
      tools: "Outils :",
      tool1: "React : Bibliothèque frontend principale pour l'architecture basée sur les composants",
      tool2: "TypeScript : Garantir la sécurité des types et une meilleure expérience développeur",
      tool3: "Tailwind CSS : Framework CSS utilitaire pour un développement UI rapide",
      tool4: "Vercel : Plateforme cloud pour les sites statiques et les fonctions serverless",
  ...
  KO: {
    ...
    projects: {
      ...
      getPricing: "맞춤 가격 받기",
      name: "LocalHands",
      subtitle: "숙련된 손으로 커뮤니티 연결",
      category: "플랫폼 · 서비스 마켓플레이스",
      description: "LocalHands는 카메룬 전역에서 지역 서비스 제공자와 이를 필요로 하는 사람들 사이의 격차를 메우기 위해 구축된 플랫폼입니다. 잡역부부터 크리에이티브까지, LocalHands는 지역 인재를 찾고, 예약하고, 신뢰하는 것을 간단하게 만듭니다.",
      responsibilities: "주요 책임:",
      resp1: "브레인스토밍: 플랫폼 비전과 핵심 기능을 개념화",
      resp2: "UI/UX 디자인: 서비스 제공자와 클라이언트를 위한 직관적인 인터페이스 제작",
      resp3: "프론트엔드 개발: 반응형, 동적 컴포넌트 구축",
      resp4: "배포: 라이브 제품 출시 및 유지 관리",
      tools: "도구:",
      tool1: "React: 컴포넌트 기반 아키텍처를 위한 주요 프론트엔드 라이브러리",
      tool2: "TypeScript: 타입 안전성과 더 나은 개발자 경험 보장",
      tool3: "Tailwind CSS: 빠른 UI 개발을 위한 유틸리티 중심 CSS 프레임워크",
      tool4: "Vercel: 정적 사이트 및 서버리스 함수를 위한 클라우드 플랫폼",
      goToWebsite: "웹사이트 방문",
    },
    // Contact
    contact: {
